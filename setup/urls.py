...
urlpatterns = [
  ...
  path('items_audit_log/', ItemsAuditLogView.as_view(), name='items-auditLog'),
  ...
  path('items_material_instalacao/<str:category>/', ItemsSubMaterialInstalacao.as_view(template_name="items/pag_subs_category/items_material_instalacao.html"), name="items_material_instalacao"),
  path('items_informatica/<str:category>/', ItemsSubInformatica.as_view(template_name="items/pag_subs_category/items_informatica.html"), name="items_informatica"),
